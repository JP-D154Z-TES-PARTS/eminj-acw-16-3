...
volatile const u1 u1g_eminj_CIMPALC_PRI = (u1)(((46.)/(1.))+0.5);       /* m=eminj,lsb=1,ofs=,unit=- :ｴﾀﾉｰﾙ燃料ｺﾝﾎﾟ噴射濃化要求の優先度 */
 #endif /* JEFFV */
#endif /* JEEFI */
...
volatile const u1 u1g_eminj_GORO_PRI = (u1)(((100.)/(1.))+0.5);         /* m=eminj,lsb=1,ofs=,unit=- :ｺﾞﾛｺﾞﾛ音対策制御要求の優先度 */
#endif                                                                  /* JECOMBCCPT_E */
