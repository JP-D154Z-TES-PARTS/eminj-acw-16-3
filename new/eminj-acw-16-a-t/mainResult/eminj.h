...
#define u1g_EMINJ_CIMPALC_ID               ((u1)(46))         /* �ٺ�ٔR���R�ĉ��P����(ID) */
...
typedef struct
{
    ...
    u1 u1_stepkcyl;                   /* lsb=1 :�C����ʕ��˗ʕ␳�i */
    f4 f4_kqcyl[u1g_EJCC_NCYL];       /* unit=�{ :�C����ʕ��˗ʕ␳�W�� */
} st_EMINJ_EMINJ_BUF;
...
#define u1g_EMINJ_STEPKCYL_VD                    0b11111111           /* �C���ʕ��˗ʕ␳�i�����l */
#define s2g_EMINJ_KQCYL_VD                       1                    /* �C���ʕ��˗ʕ␳�W�������l */
#define s2s_EMINJ_KQCYL_MN                       0                    /* �C���ʕ��˗ʕ␳�W�������l */
#define s2s_EMINJ_KQCYL_MX                       2                    /* �C���ʕ��˗ʕ␳�W������l */
#define u4g_EMINJ_RQSTEPKCYL                     0x00004000           /* �C���ʕ��˗ʕ␳�i�v���L */
#define u4g_EMINJ_RQKQCYL                        0x00008000           /* �C���ʕ��˗ʕ␳�W���v���L */
#define u1g_EMINJ_STEPKCYL1                      0b10000000           /* �C���ʕ��˗ʕ␳�i�i1�i�ځj */
#define u1g_EMINJ_STEPKCYL2                      0b01000000           /* �C���ʕ��˗ʕ␳�i�i2�i�ځj */
#define u1g_EMINJ_STEPKCYL3                      0b00100000           /* �C���ʕ��˗ʕ␳�i�i3�i�ځj */
#define u1g_EMINJ_STEPKCYL4                      0b00010000           /* �C���ʕ��˗ʕ␳�i�i4�i�ځj */
#define u1g_EMINJ_STEPKCYL5                      0b00001000           /* �C���ʕ��˗ʕ␳�i�i5�i�ځj */
#define u1g_EMINJ_STEPKCYL6                      0b00000100           /* �C���ʕ��˗ʕ␳�i�i6�i�ځj */
#define u1g_EMINJ_STEPKCYL7                      0b00000010           /* �C���ʕ��˗ʕ␳�i�i7�i�ځj */
#define u1g_EMINJ_STEPKCYL8                      0b00000001           /* �C���ʕ��˗ʕ␳�i�i8�i�ځj */
...
#define u1g_EMINJ_GORO_ID                 ((u1)(100))         /* ��ۺ�ۉ��΍�������v��(ID) */
#endif                                                                  /* JEGORO_E */
