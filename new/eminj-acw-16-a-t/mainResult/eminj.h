...
#define u1g_EMINJ_CIMPALC_ID               ((u1)(46))         /* ｱﾙｺｰﾙ燃料燃焼改善制御(ID) */
...
#define u1g_EMINJ_STEPKCYL_VD                    0b11111111           /* 気筒別噴射量補正段無効値 */
#define s2g_EMINJ_KQCYL_VD                       1                    /* 気筒別噴射量補正係数無効値 */
#define s2s_EMINJ_KQCYL_MN                       0                    /* 気筒別噴射量補正係数下限値 */
#define s2s_EMINJ_KQCYL_MX                       2                    /* 気筒別噴射量補正係数上限値 */
#define u4g_EMINJ_RQSTEPKCYL                     0x00004000           /* 気筒別噴射量補正段要求有 */
#define u4g_EMINJ_RQKQCYL                        0x00008000           /* 気筒別噴射量補正係数要求有 */
#define u1g_EMINJ_STEPKCYL1                      0b10000000           /* 気筒別噴射量補正段（1段目） */
#define u1g_EMINJ_STEPKCYL2                      0b01000000           /* 気筒別噴射量補正段（2段目） */
#define u1g_EMINJ_STEPKCYL3                      0b00100000           /* 気筒別噴射量補正段（3段目） */
#define u1g_EMINJ_STEPKCYL4                      0b00010000           /* 気筒別噴射量補正段（4段目） */
#define u1g_EMINJ_STEPKCYL5                      0b00001000           /* 気筒別噴射量補正段（5段目） */
#define u1g_EMINJ_STEPKCYL6                      0b00000100           /* 気筒別噴射量補正段（6段目） */
#define u1g_EMINJ_STEPKCYL7                      0b00000010           /* 気筒別噴射量補正段（7段目） */
#define u1g_EMINJ_STEPKCYL8                      0b00000001           /* 気筒別噴射量補正段（8段目） */
...
#define u1g_EMINJ_GORO_ID                 ((u1)(100))         /* ｺﾞﾛｺﾞﾛ音対策実現部要求(ID) */
#endif                                                                  /* JEGORO_E */
